...
try {
  ...
  version.extensions['addStepsMacro'] = {
  ...
  macros['addsteps'] = {
    handler: function(place, macroName, params, parser) {
      ...
      if (params.length != 0) {
        ...
        theString += "@@padding:" + currentIndent + "%;@@<<insert \"Step.\">>\n";
        ...
        theString += "@@padding:" + (currentIndent + indentDirection*indentAmount) + "%;@@<<display \"" + bottomPassage + "\">>"
